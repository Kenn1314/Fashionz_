            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-4 lg:px-0">
                <div>
                    ...
                    <p className="text-gray-500 mb-4">
                        Be ther first to hear about new products, exclusive events, and online offers
                    </p>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-gray-600">
                        ...
                        <li><Link to="#" className="hover:text-gray-500 transition-colors">Featuress</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center space-x-4 mb-6">
                        <a href="httpx://www.facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">
